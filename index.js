...
app.get('/', (req, res) => {
    res.send('✅ بوت واتساب السوداني يعمل بنجاح - انتظر QR Code في السجلات');
});
    ...
    try {
        ...
        sock.ev.on('connection.update', (update) => {
            ...
            if (connection === 'close') {
                ...
                console.log('❌ تم فصل الاتصال، إعادة الاتصال...', lastDisconnect.error);
                if (shouldReconnect) {
...
// تشغيل البوت
console.log('🚀 بدء تشغيل بوت واتساب السوداني...');
connectToWhatsApp();